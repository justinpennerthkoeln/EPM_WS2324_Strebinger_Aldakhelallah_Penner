...
exports.createSetting = async (collectionId) => {
	try {
		...
		await pool.query("INSERT INTO alertSettings (collection_id, setting, value) VALUES ($1, 'Git Issue Comments', true)",[collectionId]);
		await pool.query("INSERT INTO alertSettings (collection_id, setting, value) VALUES ($1, 'Git Issue Created', true)",[collectionId]);
