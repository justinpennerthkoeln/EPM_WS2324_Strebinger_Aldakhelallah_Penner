...
const GITHUBMODEL = require('./models/githubModel.js');
...
/// ******************
APP.get("/:uuid/github", async (req, res) => {
...
//********************************************
    socket.on('get-is-github-connected', async (uuid) => {
       let isConnected=false;
        ...
        socket.emit('got-is-github-connected', isConnected);
    })

    ////// ******   get readme
    socket.on('get-github-readme', async (uuid) => {
        const data = await (await GITHUBMODEL.getGithubReadme(uuid));
        socket.emit('got-github-readme', data);
    })
